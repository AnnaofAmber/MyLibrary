...
const initialState = {
  books: [
    { id: nanoid(), name: 'Хроніки Амбера', author: 'Роджер Бл', year:'', genre:'фентезі, дарк', publisher:'', cover: 'хронікиАмбера.jpg', pages:'864', color:'#102f20', textColor:'#d8e2d6', read:true, series:'', volumes:'',  },
